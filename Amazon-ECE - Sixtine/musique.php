...
<body>
  ...
  <header>
            ...
            <div class="dropdown">
              ...
              <li class="nav-item ml-4">
                ...
                <ul class="navbar-nav float-right">
                  <li class="nav-item">
                    <!-- bouton vers la connection administrateur -->
	...
	//si le BDD existe, faire le traitement
            if ($db_found) {
    //on cherche tous les items de la categorie musique
              ...
              while ($data = mysqli_fetch_assoc($result)) {
               ...
               <!-- on affiche en html tous les items trouvés -->
               <div class="row">
                <div class="col-lg-4">
                  <div class="zoom">
                    <div class="image">
               ...
               <div class="col-lg-3" id="droite">
                ...
                <div class="row">
                  ...
                  <a class="btnPanier" href="ajoutPanier.php?id=<?php echo $data['Id']; ?>">Ajouter au panier</a></div>
                </div>
              </div>
