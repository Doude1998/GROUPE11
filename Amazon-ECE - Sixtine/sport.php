  ...
  <header>
   <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
	...
	//si le BDD existe, faire le traitement
          if ($db_found) {
    //on cherche les items qui sont dans la categorie sport et loisir
            ...
            while ($data = mysqli_fetch_assoc($result)) {
             ...
             <!-- on affiche les item avec du code html -->
             <div class="row">
              <div class="col-lg-4">
                <div class="zoom">
                  <div class="image">
             ...
             <div class="col-lg-3" id="droite">
              ...
              <!-- bouton pour ajouter les articles au panier -->
...
<div id="id01" class="modal">
 <form class="modal-content animate" action="loginAcheteur.php" method="POST">
  ...
  <div class="container">
    ...
    <!-- soumettr eles infos au formulaire -->
