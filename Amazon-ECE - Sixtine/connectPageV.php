...
<head>
  ...
  <style type="text/css">
    ...
    ?>
    /*On affiche en fond d'écran le fond préféré de l'utilisateur connecté*/
    body{
...
<body>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="overlay-image">
            <!-- image bouton pour rajouter un produit sur le site -->
        ...
        <div class="col-lg-6">
          <div class="overlay-image">
            <!-- image produit pour supprimer un produit mis en vente -->
 ...
 <div class="modal" id="id02">
  <form class="modal-content animate" action="deleteItem.php.">
    ...
    <!-- afficher les articles en vente du vendeur connecté -->
    ...
    $db_found  = mysqli_select_db($db_handle, $database);
        ...
        //on cherche dans la database des vendeurs
    $sql = "SELECT * FROM Vendeur";

        //on cherche le vendeur connecté
    $sql .= " WHERE Connecte LIKE '%oui%'";
    $result = mysqli_query($db_handle, $sql);
    ...
    while ($data = mysqli_fetch_assoc($result)) {
      $vendeur = $data['Prenom'] . " " . $data['Nom'];
          ...
          //on cherche les items mis en vente par le vendeur connecté
      $sql = "SELECT * FROM Item WHERE Vendeur LIKE '%$vendeur%'";
      $result = mysqli_query($db_handle, $sql);

      while ($data = mysqli_fetch_assoc($result)) {
            //on affiche les items mis en vente par le vendeur connecté
        echo $data['Titre'] . "<br> Catégorie : " . $data['Categorie'];
        ?>
        <!-- bouton pour supprimer un item du site -->
