...
<table>
  ...
  if ($db_found) {
    //on trie les items par nombre de ventes et on affiche que les trois premiers
    ...
    while ($data = mysqli_fetch_assoc($result)) {
     ...
     <!-- on affiche les articles en code html -->
     <div class="row">
      <div class="col-lg-4">
        <div class="zoom">
          <div class="image">
     ...
     <div class="col-lg-3" id="droite">
      ...
      <!-- bouton ajouter l'article au panier -->
...
<div id="id01" class="modal">
 <form class="modal-content animate" action="loginAcheteur.php" method="POST">
  ...
  <div class="imgcontainer">
    <!-- fermer le formulaire plus icone en haut du formulaire -->
