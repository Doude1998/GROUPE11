...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <ul class="navbar-nav ml-5">
          ...
          <li>
            <div id="UtilisateurConnecte">
              <!-- code php pour trouver qui est connecté -->
              <?php
              $database = "AMAZON";
        ...
        <ul class="navbar-nav float-right">
          <li class="nav-item ml-4">
            <!-- deconnecte l'utilisateur en renvoyant vers la page deconnexion.php -->
  ...
  <h1 id="livres">Articles les mieux vendus</h1>
  <hr>
  ...
  <table>
    ...
    if ($db_found) {
      //on affiche les articles triés selon leur nombre de ventes en affichant que les trois premiers
      $sql = "SELECT * FROM Item ORDER BY NombreVente DESC LIMIT 3";
      $result = mysqli_query($db_handle, $sql);
   ...
   <div class="col-lg-3" id="droite">
     ...
     <!-- supprimer l'article du site et donc de la base de donnée item -->
